 ...
 *
 * Required qualification for buyer/investor leads. Bedrooms / property type /
 * locations live in their own steps to keep this one a quick two-tap commit.
 */
  ...
  return (
    <form onSubmit={handleSubmit} className="lead-form__step">
      ...
      <div
        ...
        role="radiogroup"
        aria-label="When are you looking to invest?"
        aria-required="true"
      >
        <p className="lead-form__section-label" id="invest-timeline-label">
      ...
      <div
        className="lead-form__section"
        role="radiogroup"
        aria-label="What's your investment budget?"
        aria-required="true"
      >
        <p className="lead-form__section-label" id="budget-label">
