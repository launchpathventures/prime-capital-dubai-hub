...
| 5-aml-compliance | 12 | ✅ |
| 6-transaction-management | 3 | ✅ |
| 7-objection-navigation | 3 | ✅ |
| 8-relationship-stewardship | 1 | ✅ |
| 9-rera-exam-prep | (embedded) | ✅ |
...
- Added `quizNumber: 1`
- Changed `module` → `relatedModule: "7.1-objection-framework"`
- Changed `passing_score` → `passingScore`
...
- Added `quizNumber: 2`
- Changed `module` → `relatedModule: "7.2-market-objections"`
- Changed `passing_score` → `passingScore`
- Added `questionCount: 8`
- Changed `time_limit_minutes` → `estimatedDuration: "10 minutes"`
- Added `createdAt` and `updatedAt` dates
...
- Added `quizNumber: 3`
- Changed `module` → `relatedModule: "7.7-failure-resilience"`
- Changed `passing_score` → `passingScore`
- Added `questionCount: 10`
- Changed `time_limit_minutes` → `estimatedDuration: "10 minutes"`
- Added `createdAt` and `updatedAt` dates
...
- Added `quizNumber: 1`
- Changed `module` → `relatedModule: "8.3-referral-generation"`
- Changed `pass_threshold: 0.8` → `passingScore: 80`
- Added `questionCount: 10`
- Added `estimatedDuration: "10 minutes"`
- Added `createdAt` and `updatedAt` dates
...
- Changed `module: 5.1` → `relatedModule: "6.1-offplan-journey"`
- Changed `estimatedDuration: 15` → `estimatedDuration: "15 minutes"`
- Added `createdAt` and `updatedAt` dates
- Removed non-standard fields: `status`, `aiCoach`
...
- Added `quizNumber: 2`
- Changed `competency: 5` → `competency: "transaction-management"`
- Changed `module: 5.3` → `relatedModule: "6.3-rera-contracts"`
- Changed `estimatedDuration: 15` → `estimatedDuration: "15 minutes"`
- Added `createdAt` and `updatedAt` dates
- Removed non-standard fields: `status`, `aiCoach`
...
- Added `quizNumber: 3`
- Changed `competency: 5` → `competency: "transaction-management"`
- Changed `module: 5.9` → `relatedModule: "6.9-mou-formf"`
- Changed `estimatedDuration: 15` → `estimatedDuration: "15 minutes"`
- Added `createdAt` and `updatedAt` dates
- Removed non-standard fields: `status`, `aiCoach`
...
| transaction-management-1.md | 6.1-offplan-journey | ✅ |
| transaction-management-2.md | 6.3-rera-contracts | ✅ |
| transaction-management-3.md | 6.9-mou-formf | ✅ |
| objection-navigation-1.md | 7.1-objection-framework | ✅ |
| objection-navigation-2.md | 7.2-market-objections | ✅ |
| objection-navigation-3.md | 7.7-failure-resilience | ✅ |
| relationship-stewardship-1.md | 8.3-referral-generation | ✅ |
