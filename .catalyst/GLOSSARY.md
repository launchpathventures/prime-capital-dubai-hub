...
Terminology and naming conventions using human-first language.
...
Clear stages so you always know where you are and what's next.

| Stage | Focus | What "Good" Looks Like |
|-------|-------|------------------------|
| **POC** | Validate the idea | Ship something stakeholders can see and steer on. Rough is fine. |
| **MVP** | Test with users | Real users, real feedback. Core flows working. |
| **MMP** | Public launch | Ready for paying customers. Polished UI, proper error handling. |
| **PROD** | Stability & scale | Enterprise-ready, security hardened, monitored. |

**Key principle:** POC quality isn't MVP quality. MVP isn't production. Advancement is a deliberate choice, not an accident.

### Two Ways to Start

| Path | Tagline | Best For |
|------|---------|----------|
| **Proof-First** | "I need to move now" | Tight deadlines, exploration, validating assumptions |
| **Intent-First** | "I need clarity first" | Stakeholder buy-in, complex projects, team alignment |
