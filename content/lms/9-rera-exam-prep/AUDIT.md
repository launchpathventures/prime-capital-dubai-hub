# Content Audit Fixes — Competency 9: RERA Exam Prep
...
### File: `9.3-regulations-licensing.md`
| Field | Before | After | Reason |
|-------|--------|-------|--------|
...
### File: `9.5-property-registration.md`
| Field | Before | After | Reason |
|-------|--------|-------|--------|
...
### File: `9.7-valuation-calculations.md`
| Field | Before | After | Reason |
|-------|--------|-------|--------|
| duration | "45 min" | (removed) | Wrong field name |
| estimatedDuration | (missing) | "45 minutes" | Required field per schema |
...
| competency | 9 | "rera-exam-prep" | Must be slug string |
| relatedModule | (missing) | "9.7-valuation-calculations" | Required field per schema |
...
| prerequisite | ["9.2"] | (removed) | Not in required schema |
...
| competency | 9 | "rera-exam-prep" | Must be slug string |
| relatedModule | (missing) | "9.2-ethics-compliance" | Required field per schema |
| questionCount | (missing) | 15 | Required field per schema |
| passingScore | (missing) | 75 | Required field per schema |
| estimatedDuration | (missing) | "20 minutes" | Required field per schema |
...
| competency | 9 | "rera-exam-prep" | Must be slug string |
| relatedModule | (missing) | "9.3-regulations-licensing" | Required field per schema |
| questionCount | (missing) | 15 | Required field per schema |
| passingScore | (missing) | 75 | Required field per schema |
| estimatedDuration | (missing) | "20 minutes" | Required field per schema |
...
| competency | 9 | "rera-exam-prep" | Must be slug string |
| relatedModule | (missing) | "9.1-exam-overview" | Required field per schema |
...
| competency | 9 | "rera-exam-prep" | Must be slug string |
| relatedModule | (missing) | "9.4-landlord-tenant" | Required field per schema |
| questionCount | (missing) | 40 | Required field per schema |
| passingScore | (missing) | 75 | Required field per schema |
| estimatedDuration | (missing) | "60 minutes" | Required field per schema |
...
| competency | 9 | "rera-exam-prep" | Must be slug string |
| relatedModule | (missing) | "9.8-exam-strategies" | Required field per schema |
| questionCount | (missing) | 40 | Required field per schema |
| passingScore | (missing) | 75 | Required field per schema |
| estimatedDuration | (missing) | "60 minutes" | Required field per schema |
...
- [x] Module numbers sequential: 9.1 through 9.8
