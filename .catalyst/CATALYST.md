...
Speed isn't the problem — **drift** is.
...
AI makes building faster — but speed alone doesn't keep you aligned. When you can build quickly, it becomes easier to build the wrong thing quickly. Speed without structure creates invisible risk.

---

## What is Catalyst?

**A method and a kit — working together.**

1. **The Method** — A repeatable delivery rhythm that keeps AI builds aligned and stakeholders in the loop
2. **The Kit** — Surfaces, components, and conventions AI can follow out of the box
...
- **Not "vibe coding"** — it's building the right thing, fast, with decisions captured
- **Not "a template you outgrow"** — most starter kits help you begin; Catalyst helps you **finish**
...
- **Proof-First:** "I need to move now" — Clone the kit, build the proof, discover as you go
- **Intent-First:** "I need clarity first" — Start with Vision/Architecture/Brief, get aligned, then build
...
|--------|---------|----------|
| `core/` | Layout & typography building blocks | `Stack`, `Row`, `Text`, `Title` |
...
├── project-state.md    # Stage, focus, health
