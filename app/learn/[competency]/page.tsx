    ...
    modules: [
      {
        ...
        description: "Understanding different investor types, nationality patterns, and their motivations",
        duration: "30 min",
        status: "completed",
      },
      {
        ...
        description: "Conducting discovery conversations for homebuyers and lifestyle seekers",
        duration: "35 min",
        status: "completed",
      },
      {
        ...
        description: "Qualifying investment buyers using the Goal Behind the Goal technique",
        duration: "40 min",
        status: "completed",
      },
      {
        ...
        description: "Qualifying Golden Visa seekers and correcting common misconceptions",
        duration: "35 min",
        status: "completed",
      },
      {
        ...
        description: "Reading between lines, recognizing buying signals vs politeness",
        duration: "30 min",
        status: "in-progress",
      },
      {
        ...
        description: "The 5-Minute Qualifier and Decision Map framework",
        duration: "35 min",
        status: "not-started",
      },
      {
        ...
        description: "Setting realistic expectations on yields, timelines, and processes",
        duration: "30 min",
        status: "not-started",
      },
    ],
