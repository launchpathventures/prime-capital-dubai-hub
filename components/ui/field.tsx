...
function FieldSet({ className, ...props }: React.ComponentProps<"fieldset">) {
  return (
    <fieldset
      data-slot="field-set"
      className={cn("ui-field-set", "gap-6 has-[>[data-slot=checkbox-group]]:gap-3 has-[>[data-slot=radio-group]]:gap-3 flex flex-col", className)}
      {...props}
    />
  )
}
...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn("ui-field__legend", "mb-3 font-medium data-[variant=label]:text-sm data-[variant=legend]:text-base", className)}
      {...props}
    />
  )
}
...
function Field({
  ...
  return (
    <div
      ...
      className={cn("ui-field", fieldVariants({ orientation }), className)}
      {...props}
    />
  )
}
...
function FieldSeparator({
  ...
  return (
    <div
      ...
      className={cn("ui-field__separator", "-my-2 h-5 text-sm group-data-[variant=outline]/field-group:-mb-2 relative", className)}
      {...props}
    >
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("ui-field__error", "text-destructive text-sm font-normal", className)}
      {...props}
    >
      {content}
    </div>
