/**
 * CATALYST - Docs Surface Documentation
 */
...
export default function DocsSurfacePage() {
  const [tab, setTab] = useHashState("_default", "overview")

  return (
    <article className="space-y-8">
      <header className="space-y-2">
        <h1 className="text-3xl font-semibold tracking-tight">Docs Surface</h1>
        <p className="text-muted-foreground text-lg leading-relaxed">
          Developer documentation and reference material with sidebar navigation.
        </p>
      </header>
