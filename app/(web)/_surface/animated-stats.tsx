...
function AnimatedStatValue({
  ...
  return (
    <div className="font-headline text-[var(--web-off-white)] text-[clamp(22px,5vw,52px)] font-normal leading-none mb-1 md:mb-2">
      {prefix && (
  ...
  return (
    <section id="stats-section" className="web-stats-bar shrink-0">
      <Container size="xl">
        <div
          ref={ref}
          className="stats-grid grid grid-cols-2 md:grid-cols-4 py-3 md:py-8 text-center"
        >
          {stats.map((stat, index) => (
            <div
              key={stat.id}
              className="stat-item py-2 md:py-0 px-4"
              data-index={index}
              style={{
