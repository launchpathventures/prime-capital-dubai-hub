/**
 * CATALYST - Tooltip Component
 *
 * @source shadcn/ui + @base-ui/react
 * @customised No — stock component
 *
 * @ai-note Do NOT add `cursor-help` or `cursor-pointer` classes to TooltipTrigger.
 * The default cursor is correct. Tooltip triggers should feel natural, not signal "help".
 */
